 ...
 *  - `DealSummaryCard({ deal })` — default export. Called by: `ChatPage`,
 *    `DealsByPersonPage`. Not to be confused with `DealCard`, which renders the
 *    cards *inside* a vault (T3.36–T3.39); this one is the deal seen from
 *    outside.
 */
