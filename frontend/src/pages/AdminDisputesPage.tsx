            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  <MonoText className="text-xs text-muted break-all">
                    #{d.id.slice(0, 8)}
                  </MonoText>
                  <span
                ...
                {resolvingId === d.id && (
                  <div className="mt-3 pt-3 border-t border-navy/10 space-y-2">
                    ...
                    />
                    <label className="flex items-center gap-2 text-xs font-body text-muted">
                      <input
                        type="checkbox"
                        checked={closesDeal}
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="text-xs font-body text-muted hover:text-navy px-2"
                      >
                        {t('common.cancel')}
                      </button>
                    </div>
