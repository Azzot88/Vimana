...
### T_UX.7 — Один бренд вместо четырёх: токены, новый лендинг, ревизия экранов
...
**pt.3 — ревизия экранов** продукта под единые токены. Уже найденный материал: в `AcceptInvitePage` строки захардкожены по-русски мимо i18n, там же `border-green-200` мимо токенов.
