...
### T3.21 — Identity Vault: формат `.dvlt` v1 и скачивание (ступень 2)
...
### T3.22 — Независимость: удаление копии с платформы (ступень 3)
...
### T3.23 — Привязка своей личности: импорт (быстрый путь)
...
### T3.24 — Ридер `.dvlt`: открыть без платформы
