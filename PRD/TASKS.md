...
### T3.18 — Публичная страница личности 🟨 pt.1 готов
...
**pt.2 — фронт `/i/{npub}` ⬜** и настройка видимости в профиле. Плюс обход графа по `peer_verified` (публичные поручительства) — он же нужен `T3.19`, чтобы к завершённой личности можно было прийти прогулкой по рёбрам.
