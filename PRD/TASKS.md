...
**Acceptance: ✅ все выполнены** — одна личность, несколько passkey'ев; вход с привязанного устройства даёт тот же аккаунт; отвязка не меняет npub и не трогает остальные способы; последний способ входа удалить нельзя. **11/11 Playwright, 20/20 vitest** (2026-07-29). Полный backend-прогон — см. ниже.
