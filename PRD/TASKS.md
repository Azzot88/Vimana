...
**Результат задачи:** решение в Decision Log под заголовком `D-KEY-TIERS`, переписанные T3.16 и T3.17 под новую модель, обновлённый `keys.md` (пользовательский документ описывает текущую схему и станет неверным).
