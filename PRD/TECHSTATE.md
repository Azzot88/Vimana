...
| Route notes + platform disclaimers | 3 | 🟨 pt.2 (T_UX.2: backend + admin CRUD + PlatformNoticeBanner в Layout). Остаётся: TripCard pill + NewTripPage modal + DealPage banner + DealVault system-msg + i18n backing реальными переводами — pt.3. |
