...
| Форма публикации рейса: переработка под разбор переписок | 3.11 | 🟨 маршрут-цепочка, две вместимости, два конца передачи готовы; экспресс-путь, запреты, животные, Nostr-цепочка — нет (T3.11.07, 2026-09-06) |
