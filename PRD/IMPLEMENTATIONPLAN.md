...
5. **Фи за эскроу — поток A из трёх (MASTERPLAN §4.1).** Процент берётся от **объявленной стоимости груза**, не от вознаграждения перевозчику; шкала регрессивная 5 / 3 / 2 %. Комиссия со сделки как таковой не берётся — мэтчинг бесплатен. Объявленная стоимость одновременно задаёт размер залога, базу комиссии и потолок выплаты в споре.
6. **Graceful degradation:** при недоступности крипто-слоя сделки Фаз 1–4 продолжают работать.
7. **Ограничение объёма:** полный залог, равный объявленной стоимости, недостижим для большинства перевозчиков. Модель залога (частичный / ступенчатый по УБА / гарантийный пул) — открытое решение MASTERPLAN §4.1, блокирует расчёт выручки потока A.
