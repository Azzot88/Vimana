...
3. Гейт мягкий: неподтверждённый email не блокирует вход, блокирует создание сделок и рейсов.
...
- [ ] Неподтверждённый email не мешает войти, но мешает создать сделку?
