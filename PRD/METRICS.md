...
| **Эффективная ставка A** | выручка потока A / Escrowed GMV | в коридоре 2–5 % | 5 |
| **Collateral coverage** | залог / объявленная стоимость | целевой уровень зависит от модели залога | 5 |
