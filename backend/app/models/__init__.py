...
from app.models.marketplace import Trip, TripSegment, Cargo, TripStatus, Category, DEFAULT_CATEGORIES, Chat, ChatMessage, SenderRequest
...
__all__ = [
    ...
    "Trip", "TripSegment", "Cargo", "TripStatus", "Category", "DEFAULT_CATEGORIES",
    "Chat", "ChatMessage",
